    ...
    return (
        ...
        <div className="max-w-sm mx-auto relative h-[700px] bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="p-5">
                ...
                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Quantity: {quantity}</p>
                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Supplier Name: {supplier}</p>
